  ...
  },
  {
    ...
    "fields": [
      ...
      },
      {
        "key": "term_meaning",
        "label": "각 용어의 실무적 의미",
        "hint": "용어를 이 산업에서 실제로 어떻게 쓰는지 정리합니다. 아래 'GenAI 용어 분석 프롬프트'를 AI에 입력한 결과를 붙여 넣고 본인 표현으로 다듬어도 좋습니다.",
        "rows": 5
      },
      {
        "key": "work_flow",
        "label": "주요 업무의 시간 순서, 협업 부서, 산출물",
        "hint": "채용공고의 업무를 '언제 → 누구와 → 무엇을 만드는지' 순서로 정리합니다. AI에게 정리 도움을 요청한 결과를 붙여 넣고 본인 표현으로 다듬어도 좋습니다.",
        "rows": 5
      },
      {
